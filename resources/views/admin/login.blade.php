...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('{{asset('admin/assets/img/login.jpg')}}'); background-size: cover; background-position: top center;">
            ...
            <form class="form" method="POST" action="">
              ...
              <div class="card card-login card-hidden">
                <div class="card-header card-header-rose text-center">
                  <h4 class="card-title">Login Admin UMKM Kemuning</h4>
                </div>
                <div class="card-body ">
                ...
                <div class="card-footer justify-content-center">
                  <a href="#" onclick="document.forms[0].submit();return false;" class="btn btn-rose btn-link btn-lg">Login</a>
                </div>
              </div>
            </form> 
          </div>
