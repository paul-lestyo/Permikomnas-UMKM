<header class="header-area section-padding-1 header-ptb-3 transparent-bar">
    <div class="header-large-device">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="header-action-wrap header-action-flex-center sticky-bar">
                                ...
                                <ul>
                                    <li><a href="index.html">Home</a>
                                        <ul class="mega-menu-style-1 mega-menu-width1 menu-negative-mrg1">
                                            <li class="mega-menu-sub-width33"><a class="menu-title" href="#">Home
                                                    Group #01</a>
                                                <ul>
                                    ...
                                    <li><a href="shop.html">Shop</a>
                                        <ul class="mega-menu-style-1 mega-menu-width2 menu-negative-mrg3">
                                            <li class="mega-menu-sub-width20"><a class="menu-title" href="#">Shop
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="shop-list-no-sidebar.html">Shop List Style 2</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="mega-menu-sub-width20"><a class="menu-title" href="#">Product
                                                    Layout</a>
                                                <ul>
                                            ...
                                            <li class="mega-menu-sub-width40">
                                                <div class="banner-menu-content-wrap default-overlay">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('front') }}/assets/images/menu/banner-header-1.jpg"
                                                            alt="banner"></a>
                        ...
                        <div class="same-style header-search-3 same-style-gray">
                            <a class="search-toggle" href="#">
                                <i class="icofont-search-1 s-open"></i>
                                <i class="icofont-close-line s-close"></i>
                            </a>
    ...
    <div class="header-small-device sticky-bar header-ptb-1">
        <div class="container-fluid">
